...
const Navbar = () => {
  ...
  const { activeMenu, setActiveMenu, 
    ...
    screenSize, setScreenSize, handleClick } = useStateContext();

    useEffect(() => {
      //listens for screen resize and sets the screen isze to current screen width
        ...
        >
          ...
          onClick={() => handleClick("userProfile")}>
            ...
            <p>
              ...
              <span className="text-gray-400 font-bold ml-1 text-14">TED</span>
            </p>
